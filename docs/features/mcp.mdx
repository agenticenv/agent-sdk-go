...
[MCP](https://modelcontextprotocol.io) servers extend your agent with external tools that work identically to built-in tools across `Run`, `Stream`, and approval gates.
